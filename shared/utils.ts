...
function getExpandedPrice2(price) {
    return bigNumberify(price).mul(expandDecimals(1, 22))
}
...
export { deployContract, expandDecimals, bigNumberify, getPriceBits, getExpandedPrice, getExpandedPrice2, getBlockTime, toUsd, mineBlock, increaseTime, priceUpdateAndExcute, encode}